...
class CreateIntakeForms extends Migration
{
    /**
     * Run the migrations.
     *
...
/*
        ...
        */
            ...
            */
            ...
            $table->text('motor_workplace')->nullable(); // do both motor or workplace
